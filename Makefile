...
xdr/curr-version: $(wildcard .git/modules/xdr/curr/**/*) $(wildcard xdr/curr/*.x)
	git submodule status -- xdr/curr | cut -f 1 -d " " > xdr/curr-version
...
xdr/next-version: $(wildcard .git/modules/xdr/curr/**/*) $(wildcard xdr/next/*.x)
	git submodule status -- xdr/next | cut -f 1 -d " " > xdr/next-version
