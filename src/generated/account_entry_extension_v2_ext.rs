...
impl AccountEntryExtensionV2Ext {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_account_entry_extension_v2_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`AccountEntryExtensionV2Ext`], mirroring `<AccountEntryExtensionV2Ext as WriteXdr>::write_xdr`.
    pub const fn write_type_account_entry_extension_v2_ext(
        &mut self,
        v: &AccountEntryExtensionV2Ext,
    ) {
        ...
        match v {
            ...
            AccountEntryExtensionV2Ext::V3(value) => {
                self.write_type_account_entry_extension_v3(value);
            }
        }
    }
}
