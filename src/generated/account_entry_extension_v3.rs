...
impl AccountEntryExtensionV3 {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_account_entry_extension_v3(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`AccountEntryExtensionV3`], mirroring `<AccountEntryExtensionV3 as WriteXdr>::write_xdr`.
    pub const fn write_type_account_entry_extension_v3(&mut self, v: &AccountEntryExtensionV3) {
        self.write_type_extension_point(&v.ext);
        self.write_u32(v.seq_ledger);
        self.write_type_time_point(&v.seq_time);
    }
}
