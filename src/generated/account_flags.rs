...
impl AccountFlags {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_account_flags(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`AccountFlags`], mirroring `<AccountFlags as WriteXdr>::write_xdr`.
    pub const fn write_type_account_flags(&mut self, v: &AccountFlags) {
