...
impl AllowTrustResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_allow_trust_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`AllowTrustResultCode`], mirroring `<AllowTrustResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_allow_trust_result_code(&mut self, v: &AllowTrustResultCode) {
