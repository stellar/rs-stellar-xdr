...
#[cfg(feature = "const")]
impl BeginSponsoringFutureReservesOp {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_begin_sponsoring_future_reserves_op(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`BeginSponsoringFutureReservesOp`], mirroring `<BeginSponsoringFutureReservesOp as WriteXdr>::write_xdr`.
    pub const fn write_type_begin_sponsoring_future_reserves_op(
        &mut self,
        v: &BeginSponsoringFutureReservesOp,
    ) {
        self.write_type_account_id(&v.sponsored_id);
    }
}
