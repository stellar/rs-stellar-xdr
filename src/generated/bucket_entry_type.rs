...
impl BucketEntryType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_bucket_entry_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`BucketEntryType`], mirroring `<BucketEntryType as WriteXdr>::write_xdr`.
    pub const fn write_type_bucket_entry_type(&mut self, v: &BucketEntryType) {
