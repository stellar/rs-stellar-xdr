...
impl BucketListType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_bucket_list_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`BucketListType`], mirroring `<BucketListType as WriteXdr>::write_xdr`.
    pub const fn write_type_bucket_list_type(&mut self, v: &BucketListType) {
