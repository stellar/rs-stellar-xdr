...
impl BumpSequenceResult {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_bump_sequence_result(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`BumpSequenceResult`], mirroring `<BumpSequenceResult as WriteXdr>::write_xdr`.
    pub const fn write_type_bump_sequence_result(&mut self, v: &BumpSequenceResult) {
        let d = v.discriminant();
        self.write_type_bump_sequence_result_code(&d);
        #[allow(clippy::match_same_arms)]
        match v {
