...
impl BumpSequenceResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_bump_sequence_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`BumpSequenceResultCode`], mirroring `<BumpSequenceResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_bump_sequence_result_code(&mut self, v: &BumpSequenceResultCode) {
