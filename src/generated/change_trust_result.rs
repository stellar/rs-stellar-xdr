...
impl ChangeTrustResult {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_change_trust_result(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ChangeTrustResult`], mirroring `<ChangeTrustResult as WriteXdr>::write_xdr`.
    pub const fn write_type_change_trust_result(&mut self, v: &ChangeTrustResult) {
        let d = v.discriminant();
        self.write_type_change_trust_result_code(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            ...
            ChangeTrustResult::LowReserve => {}
            ChangeTrustResult::SelfNotAllowed => {}
            ChangeTrustResult::TrustLineMissing => {}
            ChangeTrustResult::CannotDelete => {}
