...
impl ClaimAtomType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_claim_atom_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClaimAtomType`], mirroring `<ClaimAtomType as WriteXdr>::write_xdr`.
    pub const fn write_type_claim_atom_type(&mut self, v: &ClaimAtomType) {
