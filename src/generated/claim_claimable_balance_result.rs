...
#[cfg(feature = "alloc")]
impl IntoOwned for ClaimClaimableBalanceResult {
    type Owned = ClaimClaimableBalanceResult;
    fn into_owned(self) -> ClaimClaimableBalanceResult {
        self
    }
}
...
impl ClaimClaimableBalanceResult {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_claim_claimable_balance_result(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClaimClaimableBalanceResult`], mirroring `<ClaimClaimableBalanceResult as WriteXdr>::write_xdr`.
    pub const fn write_type_claim_claimable_balance_result(
        &mut self,
        v: &ClaimClaimableBalanceResult,
    ) {
        let d = v.discriminant();
        self.write_type_claim_claimable_balance_result_code(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            ClaimClaimableBalanceResult::Success => {}
            ClaimClaimableBalanceResult::DoesNotExist => {}
            ClaimClaimableBalanceResult::CannotClaim => {}
            ClaimClaimableBalanceResult::LineFull => {}
            ClaimClaimableBalanceResult::NoTrust => {}
