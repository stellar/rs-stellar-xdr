...
#[cfg(feature = "alloc")]
impl IntoOwned for ClaimClaimableBalanceResultCode {
    type Owned = ClaimClaimableBalanceResultCode;
    fn into_owned(self) -> ClaimClaimableBalanceResultCode {
        self
    }
}
...
impl ClaimClaimableBalanceResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_claim_claimable_balance_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClaimClaimableBalanceResultCode`], mirroring `<ClaimClaimableBalanceResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_claim_claimable_balance_result_code(
        &mut self,
        v: &ClaimClaimableBalanceResultCode,
    ) {
