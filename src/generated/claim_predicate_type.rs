...
impl ClaimPredicateType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_claim_predicate_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClaimPredicateType`], mirroring `<ClaimPredicateType as WriteXdr>::write_xdr`.
    pub const fn write_type_claim_predicate_type(&mut self, v: &ClaimPredicateType) {
