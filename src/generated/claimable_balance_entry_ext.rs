...
impl ClaimableBalanceEntryExt {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_claimable_balance_entry_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClaimableBalanceEntryExt`], mirroring `<ClaimableBalanceEntryExt as WriteXdr>::write_xdr`.
    pub const fn write_type_claimable_balance_entry_ext(&mut self, v: &ClaimableBalanceEntryExt) {
        ...
        match v {
            ...
            ClaimableBalanceEntryExt::V1(value) => {
                self.write_type_claimable_balance_entry_extension_v1(value);
            }
        }
    }
}
