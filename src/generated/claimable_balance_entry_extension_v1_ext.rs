...
impl ClaimableBalanceEntryExtensionV1Ext {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_claimable_balance_entry_extension_v1_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClaimableBalanceEntryExtensionV1Ext`], mirroring `<ClaimableBalanceEntryExtensionV1Ext as WriteXdr>::write_xdr`.
    pub const fn write_type_claimable_balance_entry_extension_v1_ext(
        &mut self,
        v: &ClaimableBalanceEntryExtensionV1Ext,
    ) {
        let d = v.discriminant();
        self.write_i32(d);
        #[allow(clippy::match_same_arms)]
        match v {
            ClaimableBalanceEntryExtensionV1Ext::V0 => {}
        }
    }
}
