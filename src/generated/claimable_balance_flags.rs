...
impl ClaimableBalanceFlags {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_claimable_balance_flags(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClaimableBalanceFlags`], mirroring `<ClaimableBalanceFlags as WriteXdr>::write_xdr`.
    pub const fn write_type_claimable_balance_flags(&mut self, v: &ClaimableBalanceFlags) {
