...
impl ClaimableBalanceId {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_claimable_balance_id(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClaimableBalanceId`], mirroring `<ClaimableBalanceId as WriteXdr>::write_xdr`.
    pub const fn write_type_claimable_balance_id(&mut self, v: &ClaimableBalanceId) {
        let d = v.discriminant();
        self.write_type_claimable_balance_id_type(&d);
        #[allow(clippy::match_same_arms)]
        match v {
