...
#[cfg(feature = "alloc")]
impl IntoOwned for ClaimableBalanceIdType {
    type Owned = ClaimableBalanceIdType;
    fn into_owned(self) -> ClaimableBalanceIdType {
        self
    }
}
...
impl ClaimableBalanceIdType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_claimable_balance_id_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClaimableBalanceIdType`], mirroring `<ClaimableBalanceIdType as WriteXdr>::write_xdr`.
    pub const fn write_type_claimable_balance_id_type(&mut self, v: &ClaimableBalanceIdType) {
