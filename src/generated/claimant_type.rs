...
impl ClaimantType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_claimant_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClaimantType`], mirroring `<ClaimantType as WriteXdr>::write_xdr`.
    pub const fn write_type_claimant_type(&mut self, v: &ClaimantType) {
