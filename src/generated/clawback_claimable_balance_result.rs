...
impl ClawbackClaimableBalanceResult {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_clawback_claimable_balance_result(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClawbackClaimableBalanceResult`], mirroring `<ClawbackClaimableBalanceResult as WriteXdr>::write_xdr`.
    pub const fn write_type_clawback_claimable_balance_result(
        &mut self,
        v: &ClawbackClaimableBalanceResult,
    ) {
        let d = v.discriminant();
        self.write_type_clawback_claimable_balance_result_code(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            ClawbackClaimableBalanceResult::Success => {}
            ClawbackClaimableBalanceResult::DoesNotExist => {}
            ClawbackClaimableBalanceResult::NotIssuer => {}
