...
impl ClawbackClaimableBalanceResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_clawback_claimable_balance_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClawbackClaimableBalanceResultCode`], mirroring `<ClawbackClaimableBalanceResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_clawback_claimable_balance_result_code(
        &mut self,
        v: &ClawbackClaimableBalanceResultCode,
    ) {
