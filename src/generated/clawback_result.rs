...
#[cfg(feature = "alloc")]
impl IntoOwned for ClawbackResult {
    type Owned = ClawbackResult;
    fn into_owned(self) -> ClawbackResult {
        self
    }
}
...
impl ClawbackResult {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_clawback_result(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClawbackResult`], mirroring `<ClawbackResult as WriteXdr>::write_xdr`.
    pub const fn write_type_clawback_result(&mut self, v: &ClawbackResult) {
        let d = v.discriminant();
        self.write_type_clawback_result_code(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            ClawbackResult::Success => {}
            ClawbackResult::Malformed => {}
            ClawbackResult::NotClawbackEnabled => {}
            ClawbackResult::NoTrust => {}
            ClawbackResult::Underfunded => {}
        }
    }
}
