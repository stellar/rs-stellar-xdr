...
impl ClawbackResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_clawback_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ClawbackResultCode`], mirroring `<ClawbackResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_clawback_result_code(&mut self, v: &ClawbackResultCode) {
