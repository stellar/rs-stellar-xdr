...
impl ConfigSettingContractEventsV0 {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_config_setting_contract_events_v0(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ConfigSettingContractEventsV0`], mirroring `<ConfigSettingContractEventsV0 as WriteXdr>::write_xdr`.
    pub const fn write_type_config_setting_contract_events_v0(
        &mut self,
        v: &ConfigSettingContractEventsV0,
    ) {
        self.write_u32(v.tx_max_contract_events_size_bytes);
        self.write_i64(v.fee_contract_events1_kb);
    }
}
