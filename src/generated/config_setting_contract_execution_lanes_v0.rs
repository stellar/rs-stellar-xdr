...
impl ConfigSettingContractExecutionLanesV0 {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_config_setting_contract_execution_lanes_v0(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ConfigSettingContractExecutionLanesV0`], mirroring `<ConfigSettingContractExecutionLanesV0 as WriteXdr>::write_xdr`.
    pub const fn write_type_config_setting_contract_execution_lanes_v0(
        &mut self,
        v: &ConfigSettingContractExecutionLanesV0,
    ) {
        self.write_u32(v.ledger_max_tx_count);
    }
}
