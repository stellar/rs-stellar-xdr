...
impl ConfigSettingId {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_config_setting_id(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ConfigSettingId`], mirroring `<ConfigSettingId as WriteXdr>::write_xdr`.
    pub const fn write_type_config_setting_id(&mut self, v: &ConfigSettingId) {
