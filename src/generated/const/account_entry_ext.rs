...
/// AccountEntryExt is a borrowing equivalent of [`AccountEntryExt`](super::super::AccountEntryExt)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_account_entry_ext(&mut self, v: &AccountEntryExt) {
