...
/// ContractCodeEntry is a borrowing equivalent of [`ContractCodeEntry`](super::super::ContractCodeEntry)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_contract_code_entry(&mut self, v: &ContractCodeEntry) {
