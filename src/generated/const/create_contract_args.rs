...
/// CreateContractArgs is a borrowing equivalent of [`CreateContractArgs`](super::super::CreateContractArgs)
...
impl CreateContractArgs {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_create_contract_args(self);
        w.len()
    }
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_create_contract_args(&mut self, v: &CreateContractArgs) {
