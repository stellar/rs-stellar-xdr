...
/// FeeBumpTransactionInnerTx is a borrowing equivalent of [`FeeBumpTransactionInnerTx`](super::super::FeeBumpTransactionInnerTx)
...
impl FeeBumpTransactionInnerTx {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_fee_bump_transaction_inner_tx(self);
        w.len()
    }
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_fee_bump_transaction_inner_tx(
        &mut self,
        v: &FeeBumpTransactionInnerTx,
    ) {
        let d = v.discriminant();
        self.write_type_envelope_type(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            FeeBumpTransactionInnerTx::Tx(value) => {
