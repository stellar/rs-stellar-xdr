...
/// FreezeBypassTxsDelta is a borrowing equivalent of [`FreezeBypassTxsDelta`](super::super::FreezeBypassTxsDelta)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_freeze_bypass_txs_delta(&mut self, v: &FreezeBypassTxsDelta) {
