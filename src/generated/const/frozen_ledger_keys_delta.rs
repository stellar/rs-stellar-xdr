...
/// FrozenLedgerKeysDelta is a borrowing equivalent of [`FrozenLedgerKeysDelta`](super::super::FrozenLedgerKeysDelta)
...
impl FrozenLedgerKeysDelta {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_frozen_ledger_keys_delta(self);
        w.len()
    }
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_frozen_ledger_keys_delta(&mut self, v: &FrozenLedgerKeysDelta) {
