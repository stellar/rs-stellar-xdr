...
/// InflationResult is a borrowing equivalent of [`InflationResult`](super::super::InflationResult)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_inflation_result(&mut self, v: &InflationResult) {
        let d = v.discriminant();
        self.write_type_inflation_result_code(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            InflationResult::Success(value) => {
