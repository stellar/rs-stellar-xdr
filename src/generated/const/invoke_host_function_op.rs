...
/// InvokeHostFunctionOp is a borrowing equivalent of [`InvokeHostFunctionOp`](super::super::InvokeHostFunctionOp)
...
impl InvokeHostFunctionOp {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_invoke_host_function_op(self);
        w.len()
    }
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_invoke_host_function_op(&mut self, v: &InvokeHostFunctionOp) {
