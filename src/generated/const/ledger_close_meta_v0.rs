...
/// LedgerCloseMetaV0 is a borrowing equivalent of [`LedgerCloseMetaV0`](super::super::LedgerCloseMetaV0)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_ledger_close_meta_v0(&mut self, v: &LedgerCloseMetaV0) {
