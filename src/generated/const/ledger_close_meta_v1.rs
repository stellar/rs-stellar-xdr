...
/// LedgerCloseMetaV1 is a borrowing equivalent of [`LedgerCloseMetaV1`](super::super::LedgerCloseMetaV1)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_ledger_close_meta_v1(&mut self, v: &LedgerCloseMetaV1) {
