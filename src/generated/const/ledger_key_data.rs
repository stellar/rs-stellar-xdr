...
/// LedgerKeyData is a borrowing equivalent of [`LedgerKeyData`](super::super::LedgerKeyData)
...
impl LedgerKeyData {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_ledger_key_data(self);
        w.len()
    }
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_ledger_key_data(&mut self, v: &LedgerKeyData) {
