...
/// LedgerScpMessages is a borrowing equivalent of [`LedgerScpMessages`](super::super::LedgerScpMessages)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_ledger_scp_messages(&mut self, v: &LedgerScpMessages) {
