...
/// PathPaymentStrictReceiveResultSuccess is a borrowing equivalent of [`PathPaymentStrictReceiveResultSuccess`](super::super::PathPaymentStrictReceiveResultSuccess)
...
impl PathPaymentStrictReceiveResultSuccess {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_path_payment_strict_receive_result_success(self);
        w.len()
    }
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_path_payment_strict_receive_result_success(
        &mut self,
        v: &PathPaymentStrictReceiveResultSuccess,
    ) {
