...
/// RevokeSponsorshipOp is a borrowing equivalent of [`RevokeSponsorshipOp`](super::super::RevokeSponsorshipOp)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_revoke_sponsorship_op(&mut self, v: &RevokeSponsorshipOp) {
        let d = v.discriminant();
        self.write_type_revoke_sponsorship_type(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            RevokeSponsorshipOp::LedgerEntry(value) => {
                self.write_type_ledger_key(value);
            }
            RevokeSponsorshipOp::Signer(value) => {
