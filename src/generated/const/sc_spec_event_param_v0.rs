...
/// ScSpecEventParamV0 is a borrowing equivalent of [`ScSpecEventParamV0`](super::super::ScSpecEventParamV0)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_sc_spec_event_param_v0(&mut self, v: &ScSpecEventParamV0) {
