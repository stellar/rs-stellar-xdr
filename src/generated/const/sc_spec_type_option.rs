...
/// ScSpecTypeOption is a borrowing equivalent of [`ScSpecTypeOption`](super::super::ScSpecTypeOption)
...
impl ScSpecTypeOption {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_sc_spec_type_option(self);
        w.len()
    }
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_sc_spec_type_option(&mut self, v: &ScSpecTypeOption) {
