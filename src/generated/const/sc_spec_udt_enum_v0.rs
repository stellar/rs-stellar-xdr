...
/// ScSpecUdtEnumV0 is a borrowing equivalent of [`ScSpecUdtEnumV0`](super::super::ScSpecUdtEnumV0)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_sc_spec_udt_enum_v0(&mut self, v: &ScSpecUdtEnumV0) {
