...
/// ScSpecUdtStructFieldV0 is a borrowing equivalent of [`ScSpecUdtStructFieldV0`](super::super::ScSpecUdtStructFieldV0)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_sc_spec_udt_struct_field_v0(&mut self, v: &ScSpecUdtStructFieldV0) {
    ...
    pub const fn write_type_vec_sc_spec_udt_struct_field_v0<const MAX: u32>(
        &mut self,
        v: &VecM<ScSpecUdtStructFieldV0, MAX>,
    ) {
        let s = v.as_slice();
        let len = s.len();
        self.write_len(len);
