...
/// ScSpecUdtUnionV0 is a borrowing equivalent of [`ScSpecUdtUnionV0`](super::super::ScSpecUdtUnionV0)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_sc_spec_udt_union_v0(&mut self, v: &ScSpecUdtUnionV0) {
