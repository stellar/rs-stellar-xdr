...
/// ScpEnvelope is a borrowing equivalent of [`ScpEnvelope`](super::super::ScpEnvelope)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_scp_envelope(&mut self, v: &ScpEnvelope) {
