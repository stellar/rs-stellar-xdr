...
/// ScpStatementConfirm is a borrowing equivalent of [`ScpStatementConfirm`](super::super::ScpStatementConfirm)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_scp_statement_confirm(&mut self, v: &ScpStatementConfirm) {
