...
/// SignedTimeSlicedSurveyStartCollectingMessage is a borrowing equivalent of [`SignedTimeSlicedSurveyStartCollectingMessage`](super::super::SignedTimeSlicedSurveyStartCollectingMessage)
...
impl SignedTimeSlicedSurveyStartCollectingMessage {
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_signed_time_sliced_survey_start_collecting_message(
        &mut self,
        v: &SignedTimeSlicedSurveyStartCollectingMessage,
    ) {
