...
impl SorobanTransactionDataExt {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_soroban_transaction_data_ext(self);
        w.len()
    }
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_soroban_transaction_data_ext(&mut self, v: &SorobanTransactionDataExt) {
        let d = v.discriminant();
        self.write_i32(d);
        #[allow(clippy::match_same_arms)]
        match v {
            SorobanTransactionDataExt::V0 => {}
            SorobanTransactionDataExt::V1(value) => {
