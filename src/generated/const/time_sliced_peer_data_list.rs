...
/// TimeSlicedPeerDataList is a borrowing equivalent of [`TimeSlicedPeerDataList`](super::super::TimeSlicedPeerDataList)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_time_sliced_peer_data_list(&mut self, v: &TimeSlicedPeerDataList) {
