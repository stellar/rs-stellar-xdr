...
/// TopologyResponseBodyV2 is a borrowing equivalent of [`TopologyResponseBodyV2`](super::super::TopologyResponseBodyV2)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_topology_response_body_v2(&mut self, v: &TopologyResponseBodyV2) {
