...
/// TransactionPhase is a borrowing equivalent of [`TransactionPhase`](super::super::TransactionPhase)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_transaction_phase(&mut self, v: &TransactionPhase) {
