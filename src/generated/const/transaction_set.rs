...
/// TransactionSet is a borrowing equivalent of [`TransactionSet`](super::super::TransactionSet)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_transaction_set(&mut self, v: &TransactionSet) {
