...
/// TransactionV1Envelope is a borrowing equivalent of [`TransactionV1Envelope`](super::super::TransactionV1Envelope)
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_transaction_v1_envelope(&mut self, v: &TransactionV1Envelope) {
