...
impl ContractCodeEntryExt {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_contract_code_entry_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ContractCodeEntryExt`], mirroring `<ContractCodeEntryExt as WriteXdr>::write_xdr`.
    pub const fn write_type_contract_code_entry_ext(&mut self, v: &ContractCodeEntryExt) {
        ...
        match v {
            ...
            ContractCodeEntryExt::V1(value) => {
                self.write_type_contract_code_entry_v1(value);
            }
        }
    }
}
