...
impl ContractCostType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_contract_cost_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ContractCostType`], mirroring `<ContractCostType as WriteXdr>::write_xdr`.
    pub const fn write_type_contract_cost_type(&mut self, v: &ContractCostType) {
