...
impl ContractDataDurability {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_contract_data_durability(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ContractDataDurability`], mirroring `<ContractDataDurability as WriteXdr>::write_xdr`.
    pub const fn write_type_contract_data_durability(&mut self, v: &ContractDataDurability) {
