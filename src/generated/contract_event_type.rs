...
impl ContractEventType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_contract_event_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ContractEventType`], mirroring `<ContractEventType as WriteXdr>::write_xdr`.
    pub const fn write_type_contract_event_type(&mut self, v: &ContractEventType) {
