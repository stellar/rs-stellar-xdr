...
impl CreateAccountResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_create_account_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`CreateAccountResultCode`], mirroring `<CreateAccountResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_create_account_result_code(&mut self, v: &CreateAccountResultCode) {
