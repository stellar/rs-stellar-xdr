...
#[cfg(feature = "alloc")]
impl IntoOwned for CreateClaimableBalanceResult {
    type Owned = CreateClaimableBalanceResult;
    fn into_owned(self) -> CreateClaimableBalanceResult {
        self
    }
}
...
impl CreateClaimableBalanceResult {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_create_claimable_balance_result(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`CreateClaimableBalanceResult`], mirroring `<CreateClaimableBalanceResult as WriteXdr>::write_xdr`.
    pub const fn write_type_create_claimable_balance_result(
        &mut self,
        v: &CreateClaimableBalanceResult,
    ) {
        let d = v.discriminant();
        self.write_type_create_claimable_balance_result_code(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            CreateClaimableBalanceResult::Success(value) => {
                self.write_type_claimable_balance_id(value);
            }
            CreateClaimableBalanceResult::Malformed => {}
            CreateClaimableBalanceResult::LowReserve => {}
            CreateClaimableBalanceResult::NoTrust => {}
            CreateClaimableBalanceResult::NotAuthorized => {}
            CreateClaimableBalanceResult::Underfunded => {}
        }
    }
}
