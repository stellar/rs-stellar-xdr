...
#[cfg(feature = "alloc")]
impl IntoOwned for CreateClaimableBalanceResultCode {
    type Owned = CreateClaimableBalanceResultCode;
    fn into_owned(self) -> CreateClaimableBalanceResultCode {
        self
    }
}
...
impl CreateClaimableBalanceResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_create_claimable_balance_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`CreateClaimableBalanceResultCode`], mirroring `<CreateClaimableBalanceResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_create_claimable_balance_result_code(
        &mut self,
        v: &CreateClaimableBalanceResultCode,
    ) {
