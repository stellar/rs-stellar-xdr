...
impl Curve25519Public {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_curve25519_public(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`Curve25519Public`], mirroring `<Curve25519Public as WriteXdr>::write_xdr`.
    pub const fn write_type_curve25519_public(&mut self, v: &Curve25519Public) {
