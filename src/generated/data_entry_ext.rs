...
impl DataEntryExt {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_data_entry_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`DataEntryExt`], mirroring `<DataEntryExt as WriteXdr>::write_xdr`.
    pub const fn write_type_data_entry_ext(&mut self, v: &DataEntryExt) {
