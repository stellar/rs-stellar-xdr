...
#[cfg(feature = "alloc")]
impl IntoOwned for EndSponsoringFutureReservesResult {
    type Owned = EndSponsoringFutureReservesResult;
    fn into_owned(self) -> EndSponsoringFutureReservesResult {
        self
    }
}
...
impl EndSponsoringFutureReservesResult {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_end_sponsoring_future_reserves_result(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`EndSponsoringFutureReservesResult`], mirroring `<EndSponsoringFutureReservesResult as WriteXdr>::write_xdr`.
    pub const fn write_type_end_sponsoring_future_reserves_result(
        &mut self,
        v: &EndSponsoringFutureReservesResult,
    ) {
        let d = v.discriminant();
        self.write_type_end_sponsoring_future_reserves_result_code(&d);
        #[allow(clippy::match_same_arms)]
        match v {
