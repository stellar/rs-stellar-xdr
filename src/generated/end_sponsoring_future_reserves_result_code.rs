...
impl EndSponsoringFutureReservesResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_end_sponsoring_future_reserves_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`EndSponsoringFutureReservesResultCode`], mirroring `<EndSponsoringFutureReservesResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_end_sponsoring_future_reserves_result_code(
        &mut self,
        v: &EndSponsoringFutureReservesResultCode,
    ) {
