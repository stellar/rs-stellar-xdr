...
impl ExtendFootprintTtlResult {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_extend_footprint_ttl_result(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ExtendFootprintTtlResult`], mirroring `<ExtendFootprintTtlResult as WriteXdr>::write_xdr`.
    pub const fn write_type_extend_footprint_ttl_result(&mut self, v: &ExtendFootprintTtlResult) {
        let d = v.discriminant();
        self.write_type_extend_footprint_ttl_result_code(&d);
        #[allow(clippy::match_same_arms)]
        match v {
