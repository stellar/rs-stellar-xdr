...
#[cfg(feature = "alloc")]
impl IntoOwned for ExtendFootprintTtlResultCode {
    type Owned = ExtendFootprintTtlResultCode;
    fn into_owned(self) -> ExtendFootprintTtlResultCode {
        self
    }
}
...
impl ExtendFootprintTtlResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_extend_footprint_ttl_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ExtendFootprintTtlResultCode`], mirroring `<ExtendFootprintTtlResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_extend_footprint_ttl_result_code(
        &mut self,
        v: &ExtendFootprintTtlResultCode,
    ) {
