...
impl FeeBumpTransactionExt {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_fee_bump_transaction_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`FeeBumpTransactionExt`], mirroring `<FeeBumpTransactionExt as WriteXdr>::write_xdr`.
    pub const fn write_type_fee_bump_transaction_ext(&mut self, v: &FeeBumpTransactionExt) {
        let d = v.discriminant();
        self.write_i32(d);
        #[allow(clippy::match_same_arms)]
        match v {
            FeeBumpTransactionExt::V0 => {}
        }
    }
}
