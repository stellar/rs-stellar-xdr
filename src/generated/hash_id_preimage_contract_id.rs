...
impl HashIdPreimageContractId {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_hash_id_preimage_contract_id(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`HashIdPreimageContractId`], mirroring `<HashIdPreimageContractId as WriteXdr>::write_xdr`.
    pub const fn write_type_hash_id_preimage_contract_id(&mut self, v: &HashIdPreimageContractId) {
