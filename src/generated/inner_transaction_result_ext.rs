...
impl InnerTransactionResultExt {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_inner_transaction_result_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`InnerTransactionResultExt`], mirroring `<InnerTransactionResultExt as WriteXdr>::write_xdr`.
    pub const fn write_type_inner_transaction_result_ext(&mut self, v: &InnerTransactionResultExt) {
        let d = v.discriminant();
        self.write_i32(d);
        #[allow(clippy::match_same_arms)]
        match v {
            InnerTransactionResultExt::V0 => {}
        }
    }
}
