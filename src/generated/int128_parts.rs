...
impl Int128Parts {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_int128_parts(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`Int128Parts`], mirroring `<Int128Parts as WriteXdr>::write_xdr`.
    pub const fn write_type_int128_parts(&mut self, v: &Int128Parts) {
        self.write_i64(v.hi);
        self.write_u64(v.lo);
    }
}
