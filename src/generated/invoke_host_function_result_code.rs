...
impl InvokeHostFunctionResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_invoke_host_function_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`InvokeHostFunctionResultCode`], mirroring `<InvokeHostFunctionResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_invoke_host_function_result_code(
        &mut self,
