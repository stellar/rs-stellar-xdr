...
impl IpAddrType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_ip_addr_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`IpAddrType`], mirroring `<IpAddrType as WriteXdr>::write_xdr`.
    pub const fn write_type_ip_addr_type(&mut self, v: &IpAddrType) {
