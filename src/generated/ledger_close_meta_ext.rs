...
#[cfg(feature = "alloc")]
impl IntoOwned for LedgerCloseMetaExt {
    type Owned = LedgerCloseMetaExt;
    fn into_owned(self) -> LedgerCloseMetaExt {
        self
    }
}
...
impl LedgerCloseMetaExt {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_ledger_close_meta_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LedgerCloseMetaExt`], mirroring `<LedgerCloseMetaExt as WriteXdr>::write_xdr`.
    pub const fn write_type_ledger_close_meta_ext(&mut self, v: &LedgerCloseMetaExt) {
        ...
        match v {
            ...
            LedgerCloseMetaExt::V1(value) => {
                self.write_type_ledger_close_meta_ext_v1(value);
            }
        }
    }
}
