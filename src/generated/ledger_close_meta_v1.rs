...
impl LedgerCloseMetaV1Ref<'_> {
    ...
    pub const fn const_write_xdr(&self, w: &mut ConstWriter) {
        ...
        {
            w.enter_depth();
            let __s0 = self.tx_processing.as_slice();
            let __len0 = __s0.len();
        ...
        {
            w.enter_depth();
            let __s0 = self.upgrades_processing.as_slice();
            let __len0 = __s0.len();
            w.write_length_prefix(__len0);
            let mut __i0 = 0usize;
            while __i0 < __len0 {
        ...
        {
            w.enter_depth();
            let __s0 = self.scp_info.as_slice();
            let __len0 = __s0.len();
            w.write_length_prefix(__len0);
            let mut __i0 = 0usize;
            while __i0 < __len0 {
        ...
        {
            w.enter_depth();
            let __s0 = self.evicted_keys.as_slice();
            let __len0 = __s0.len();
            w.write_length_prefix(__len0);
            let mut __i0 = 0usize;
            while __i0 < __len0 {
