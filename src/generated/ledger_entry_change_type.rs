...
impl LedgerEntryChangeType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_ledger_entry_change_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LedgerEntryChangeType`], mirroring `<LedgerEntryChangeType as WriteXdr>::write_xdr`.
    pub const fn write_type_ledger_entry_change_type(&mut self, v: &LedgerEntryChangeType) {
