...
impl LedgerEntryExt {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_ledger_entry_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LedgerEntryExt`], mirroring `<LedgerEntryExt as WriteXdr>::write_xdr`.
    pub const fn write_type_ledger_entry_ext(&mut self, v: &LedgerEntryExt) {
        ...
        match v {
            ...
            LedgerEntryExt::V1(value) => {
                self.write_type_ledger_entry_extension_v1(value);
            }
        }
    }
}
