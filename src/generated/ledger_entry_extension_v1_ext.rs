...
#[cfg(feature = "alloc")]
impl IntoOwned for LedgerEntryExtensionV1Ext {
    type Owned = LedgerEntryExtensionV1Ext;
    fn into_owned(self) -> LedgerEntryExtensionV1Ext {
        self
    }
}
...
impl LedgerEntryExtensionV1Ext {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_ledger_entry_extension_v1_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LedgerEntryExtensionV1Ext`], mirroring `<LedgerEntryExtensionV1Ext as WriteXdr>::write_xdr`.
    pub const fn write_type_ledger_entry_extension_v1_ext(
        &mut self,
        v: &LedgerEntryExtensionV1Ext,
    ) {
        let d = v.discriminant();
        self.write_i32(d);
        #[allow(clippy::match_same_arms)]
        match v {
            LedgerEntryExtensionV1Ext::V0 => {}
        }
    }
}
