...
#[cfg(feature = "alloc")]
impl IntoOwned for LedgerHeaderExtensionV1Ext {
    type Owned = LedgerHeaderExtensionV1Ext;
    fn into_owned(self) -> LedgerHeaderExtensionV1Ext {
        self
    }
}
...
impl LedgerHeaderExtensionV1Ext {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_ledger_header_extension_v1_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LedgerHeaderExtensionV1Ext`], mirroring `<LedgerHeaderExtensionV1Ext as WriteXdr>::write_xdr`.
    pub const fn write_type_ledger_header_extension_v1_ext(
        &mut self,
        v: &LedgerHeaderExtensionV1Ext,
    ) {
        let d = v.discriminant();
        self.write_i32(d);
        #[allow(clippy::match_same_arms)]
        match v {
            LedgerHeaderExtensionV1Ext::V0 => {}
        }
    }
}
