...
impl LedgerHeaderFlags {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_ledger_header_flags(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LedgerHeaderFlags`], mirroring `<LedgerHeaderFlags as WriteXdr>::write_xdr`.
    pub const fn write_type_ledger_header_flags(&mut self, v: &LedgerHeaderFlags) {
