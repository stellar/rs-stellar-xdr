...
impl LedgerKeyOffer {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_ledger_key_offer(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LedgerKeyOffer`], mirroring `<LedgerKeyOffer as WriteXdr>::write_xdr`.
    pub const fn write_type_ledger_key_offer(&mut self, v: &LedgerKeyOffer) {
