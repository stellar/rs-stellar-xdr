...
impl LedgerUpgradeType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_ledger_upgrade_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LedgerUpgradeType`], mirroring `<LedgerUpgradeType as WriteXdr>::write_xdr`.
    pub const fn write_type_ledger_upgrade_type(&mut self, v: &LedgerUpgradeType) {
