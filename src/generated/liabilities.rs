...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`Liabilities`], mirroring `<Liabilities as WriteXdr>::write_xdr`.
    pub const fn write_type_liabilities(&mut self, v: &Liabilities) {
        self.write_i64(v.buying);
        self.write_i64(v.selling);
    }
}
