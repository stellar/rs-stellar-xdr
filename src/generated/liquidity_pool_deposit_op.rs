...
#[cfg(feature = "alloc")]
impl IntoOwned for LiquidityPoolDepositOp {
    type Owned = LiquidityPoolDepositOp;
    fn into_owned(self) -> LiquidityPoolDepositOp {
        self
    }
}
...
impl LiquidityPoolDepositOp {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_liquidity_pool_deposit_op(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LiquidityPoolDepositOp`], mirroring `<LiquidityPoolDepositOp as WriteXdr>::write_xdr`.
    pub const fn write_type_liquidity_pool_deposit_op(&mut self, v: &LiquidityPoolDepositOp) {
        self.write_type_pool_id(&v.liquidity_pool_id);
        self.write_i64(v.max_amount_a);
        self.write_i64(v.max_amount_b);
        self.write_type_price(&v.min_price);
        self.write_type_price(&v.max_price);
    }
}
