...
#[cfg(feature = "alloc")]
impl IntoOwned for LiquidityPoolDepositResult {
    type Owned = LiquidityPoolDepositResult;
    fn into_owned(self) -> LiquidityPoolDepositResult {
        self
    }
}
...
impl LiquidityPoolDepositResult {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_liquidity_pool_deposit_result(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LiquidityPoolDepositResult`], mirroring `<LiquidityPoolDepositResult as WriteXdr>::write_xdr`.
    pub const fn write_type_liquidity_pool_deposit_result(
        &mut self,
        v: &LiquidityPoolDepositResult,
    ) {
        let d = v.discriminant();
        self.write_type_liquidity_pool_deposit_result_code(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            LiquidityPoolDepositResult::Success => {}
            LiquidityPoolDepositResult::Malformed => {}
            LiquidityPoolDepositResult::NoTrust => {}
            LiquidityPoolDepositResult::NotAuthorized => {}
            LiquidityPoolDepositResult::Underfunded => {}
            LiquidityPoolDepositResult::LineFull => {}
            LiquidityPoolDepositResult::BadPrice => {}
            LiquidityPoolDepositResult::PoolFull => {}
