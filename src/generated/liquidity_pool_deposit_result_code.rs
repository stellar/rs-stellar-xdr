...
impl LiquidityPoolDepositResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_liquidity_pool_deposit_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LiquidityPoolDepositResultCode`], mirroring `<LiquidityPoolDepositResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_liquidity_pool_deposit_result_code(
        &mut self,
        v: &LiquidityPoolDepositResultCode,
    ) {
