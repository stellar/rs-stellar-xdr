...
#[cfg(feature = "alloc")]
impl IntoOwned for LiquidityPoolEntryBody {
    type Owned = LiquidityPoolEntryBody;
    fn into_owned(self) -> LiquidityPoolEntryBody {
        self
    }
}
...
impl LiquidityPoolEntryBody {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_liquidity_pool_entry_body(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LiquidityPoolEntryBody`], mirroring `<LiquidityPoolEntryBody as WriteXdr>::write_xdr`.
    pub const fn write_type_liquidity_pool_entry_body(&mut self, v: &LiquidityPoolEntryBody) {
        let d = v.discriminant();
        self.write_type_liquidity_pool_type(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            LiquidityPoolEntryBody::LiquidityPoolConstantProduct(value) => {
                self.write_type_liquidity_pool_entry_constant_product(value);
            }
        }
    }
}
