...
#[cfg(feature = "alloc")]
impl IntoOwned for LiquidityPoolParameters {
    type Owned = LiquidityPoolParameters;
    fn into_owned(self) -> LiquidityPoolParameters {
        self
    }
}
...
impl LiquidityPoolParameters {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_liquidity_pool_parameters(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LiquidityPoolParameters`], mirroring `<LiquidityPoolParameters as WriteXdr>::write_xdr`.
    pub const fn write_type_liquidity_pool_parameters(&mut self, v: &LiquidityPoolParameters) {
        let d = v.discriminant();
        self.write_type_liquidity_pool_type(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            LiquidityPoolParameters::LiquidityPoolConstantProduct(value) => {
                self.write_type_liquidity_pool_constant_product_parameters(value);
            }
        }
    }
}
