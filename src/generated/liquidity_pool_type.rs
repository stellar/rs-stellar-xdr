...
#[cfg(feature = "alloc")]
impl IntoOwned for LiquidityPoolType {
    type Owned = LiquidityPoolType;
    fn into_owned(self) -> LiquidityPoolType {
        self
    }
}
...
impl LiquidityPoolType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_liquidity_pool_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LiquidityPoolType`], mirroring `<LiquidityPoolType as WriteXdr>::write_xdr`.
    pub const fn write_type_liquidity_pool_type(&mut self, v: &LiquidityPoolType) {
