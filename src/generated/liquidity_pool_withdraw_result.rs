...
#[cfg(feature = "alloc")]
impl IntoOwned for LiquidityPoolWithdrawResult {
    type Owned = LiquidityPoolWithdrawResult;
    fn into_owned(self) -> LiquidityPoolWithdrawResult {
        self
    }
}
...
impl LiquidityPoolWithdrawResult {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_liquidity_pool_withdraw_result(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LiquidityPoolWithdrawResult`], mirroring `<LiquidityPoolWithdrawResult as WriteXdr>::write_xdr`.
    pub const fn write_type_liquidity_pool_withdraw_result(
        &mut self,
        v: &LiquidityPoolWithdrawResult,
    ) {
        let d = v.discriminant();
        self.write_type_liquidity_pool_withdraw_result_code(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            LiquidityPoolWithdrawResult::Success => {}
            LiquidityPoolWithdrawResult::Malformed => {}
            LiquidityPoolWithdrawResult::NoTrust => {}
            LiquidityPoolWithdrawResult::Underfunded => {}
            LiquidityPoolWithdrawResult::LineFull => {}
            LiquidityPoolWithdrawResult::UnderMinimum => {}
