...
#[cfg(feature = "alloc")]
impl IntoOwned for LiquidityPoolWithdrawResultCode {
    type Owned = LiquidityPoolWithdrawResultCode;
    fn into_owned(self) -> LiquidityPoolWithdrawResultCode {
        self
    }
}
...
impl LiquidityPoolWithdrawResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_liquidity_pool_withdraw_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`LiquidityPoolWithdrawResultCode`], mirroring `<LiquidityPoolWithdrawResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_liquidity_pool_withdraw_result_code(
        &mut self,
        v: &LiquidityPoolWithdrawResultCode,
    ) {
