...
impl ManageDataResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_manage_data_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ManageDataResultCode`], mirroring `<ManageDataResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_manage_data_result_code(&mut self, v: &ManageDataResultCode) {
