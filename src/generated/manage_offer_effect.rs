...
impl ManageOfferEffect {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_manage_offer_effect(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ManageOfferEffect`], mirroring `<ManageOfferEffect as WriteXdr>::write_xdr`.
    pub const fn write_type_manage_offer_effect(&mut self, v: &ManageOfferEffect) {
