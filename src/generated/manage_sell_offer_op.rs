...
impl ManageSellOfferOp {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_manage_sell_offer_op(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ManageSellOfferOp`], mirroring `<ManageSellOfferOp as WriteXdr>::write_xdr`.
    pub const fn write_type_manage_sell_offer_op(&mut self, v: &ManageSellOfferOp) {
