...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_manage_sell_offer_result(&mut self, v: &ManageSellOfferResultConst) {
        let d = v.discriminant();
        self.write_type_manage_sell_offer_result_code(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            ManageSellOfferResultConst::Success(value) => {
                self.write_type_manage_offer_success_result(value);
            }
            ManageSellOfferResultConst::Malformed => {}
            ManageSellOfferResultConst::SellNoTrust => {}
            ManageSellOfferResultConst::BuyNoTrust => {}
            ManageSellOfferResultConst::SellNotAuthorized => {}
            ManageSellOfferResultConst::BuyNotAuthorized => {}
            ManageSellOfferResultConst::LineFull => {}
            ManageSellOfferResultConst::Underfunded => {}
            ManageSellOfferResultConst::CrossSelf => {}
            ManageSellOfferResultConst::SellNoIssuer => {}
            ManageSellOfferResultConst::BuyNoIssuer => {}
            ManageSellOfferResultConst::NotFound => {}
            ManageSellOfferResultConst::LowReserve => {}
        }
    }
}
