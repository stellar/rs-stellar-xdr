...
impl ManageSellOfferResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_manage_sell_offer_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ManageSellOfferResultCode`], mirroring `<ManageSellOfferResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_manage_sell_offer_result_code(
        &mut self,
