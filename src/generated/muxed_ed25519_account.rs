...
impl MuxedEd25519Account {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_muxed_ed25519_account(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`MuxedEd25519Account`], mirroring `<MuxedEd25519Account as WriteXdr>::write_xdr`.
    pub const fn write_type_muxed_ed25519_account(&mut self, v: &MuxedEd25519Account) {
        self.write_u64(v.id);
