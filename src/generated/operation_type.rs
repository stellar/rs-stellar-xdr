...
impl OperationType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_operation_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`OperationType`], mirroring `<OperationType as WriteXdr>::write_xdr`.
    pub const fn write_type_operation_type(&mut self, v: &OperationType) {
