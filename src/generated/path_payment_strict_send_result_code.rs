...
impl PathPaymentStrictSendResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_path_payment_strict_send_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`PathPaymentStrictSendResultCode`], mirroring `<PathPaymentStrictSendResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_path_payment_strict_send_result_code(
        &mut self,
        v: &PathPaymentStrictSendResultCode,
    ) {
