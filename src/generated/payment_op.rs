...
#[cfg(feature = "alloc")]
impl IntoOwned for PaymentOp {
    type Owned = PaymentOp;
    fn into_owned(self) -> PaymentOp {
        self
    }
}
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`PaymentOp`], mirroring `<PaymentOp as WriteXdr>::write_xdr`.
    pub const fn write_type_payment_op(&mut self, v: &PaymentOp) {
