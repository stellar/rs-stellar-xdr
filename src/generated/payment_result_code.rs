...
#[cfg(feature = "alloc")]
impl IntoOwned for PaymentResultCode {
    type Owned = PaymentResultCode;
    fn into_owned(self) -> PaymentResultCode {
        self
    }
}
...
impl PaymentResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_payment_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`PaymentResultCode`], mirroring `<PaymentResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_payment_result_code(&mut self, v: &PaymentResultCode) {
