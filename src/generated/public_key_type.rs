...
impl PublicKeyType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_public_key_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`PublicKeyType`], mirroring `<PublicKeyType as WriteXdr>::write_xdr`.
    pub const fn write_type_public_key_type(&mut self, v: &PublicKeyType) {
