...
impl RevokeSponsorshipType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_revoke_sponsorship_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`RevokeSponsorshipType`], mirroring `<RevokeSponsorshipType as WriteXdr>::write_xdr`.
    pub const fn write_type_revoke_sponsorship_type(&mut self, v: &RevokeSponsorshipType) {
