...
impl ScAddressType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_sc_address_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ScAddressType`], mirroring `<ScAddressType as WriteXdr>::write_xdr`.
    pub const fn write_type_sc_address_type(&mut self, v: &ScAddressType) {
