...
#[cfg(feature = "alloc")]
impl IntoOwned for ScEnvMetaKind {
    type Owned = ScEnvMetaKind;
    fn into_owned(self) -> ScEnvMetaKind {
        self
    }
}
...
impl ScEnvMetaKind {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_sc_env_meta_kind(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ScEnvMetaKind`], mirroring `<ScEnvMetaKind as WriteXdr>::write_xdr`.
    pub const fn write_type_sc_env_meta_kind(&mut self, v: &ScEnvMetaKind) {
