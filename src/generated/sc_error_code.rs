...
#[cfg(feature = "alloc")]
impl IntoOwned for ScErrorCode {
    type Owned = ScErrorCode;
    fn into_owned(self) -> ScErrorCode {
        self
    }
}
...
impl ScErrorCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_sc_error_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ScErrorCode`], mirroring `<ScErrorCode as WriteXdr>::write_xdr`.
    pub const fn write_type_sc_error_code(&mut self, v: &ScErrorCode) {
