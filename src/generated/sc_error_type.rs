...
impl ScErrorType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_sc_error_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ScErrorType`], mirroring `<ScErrorType as WriteXdr>::write_xdr`.
    pub const fn write_type_sc_error_type(&mut self, v: &ScErrorType) {
