...
impl ScMetaKind {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_sc_meta_kind(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ScMetaKind`], mirroring `<ScMetaKind as WriteXdr>::write_xdr`.
    pub const fn write_type_sc_meta_kind(&mut self, v: &ScMetaKind) {
