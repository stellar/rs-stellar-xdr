...
impl ScNonceKey {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_sc_nonce_key(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ScNonceKey`], mirroring `<ScNonceKey as WriteXdr>::write_xdr`.
    pub const fn write_type_sc_nonce_key(&mut self, v: &ScNonceKey) {
