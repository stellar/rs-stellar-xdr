...
impl ScSpecEventDataFormat {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_sc_spec_event_data_format(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ScSpecEventDataFormat`], mirroring `<ScSpecEventDataFormat as WriteXdr>::write_xdr`.
    pub const fn write_type_sc_spec_event_data_format(&mut self, v: &ScSpecEventDataFormat) {
