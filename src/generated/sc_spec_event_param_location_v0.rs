...
impl ScSpecEventParamLocationV0 {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_sc_spec_event_param_location_v0(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ScSpecEventParamLocationV0`], mirroring `<ScSpecEventParamLocationV0 as WriteXdr>::write_xdr`.
    pub const fn write_type_sc_spec_event_param_location_v0(
        &mut self,
        v: &ScSpecEventParamLocationV0,
    ) {
