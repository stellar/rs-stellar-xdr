...
impl ScSpecType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_sc_spec_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ScSpecType`], mirroring `<ScSpecType as WriteXdr>::write_xdr`.
    pub const fn write_type_sc_spec_type(&mut self, v: &ScSpecType) {
