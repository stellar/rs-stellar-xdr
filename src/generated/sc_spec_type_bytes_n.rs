...
impl ScSpecTypeBytesN {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_sc_spec_type_bytes_n(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ScSpecTypeBytesN`], mirroring `<ScSpecTypeBytesN as WriteXdr>::write_xdr`.
    pub const fn write_type_sc_spec_type_bytes_n(&mut self, v: &ScSpecTypeBytesN) {
        self.write_u32(v.n);
    }
}
