...
impl ScSpecUdtUnionCaseV0Kind {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_sc_spec_udt_union_case_v0_kind(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ScSpecUdtUnionCaseV0Kind`], mirroring `<ScSpecUdtUnionCaseV0Kind as WriteXdr>::write_xdr`.
    pub const fn write_type_sc_spec_udt_union_case_v0_kind(
        &mut self,
        v: &ScSpecUdtUnionCaseV0Kind,
    ) {
