...
impl ScpStatementType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_scp_statement_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`ScpStatementType`], mirroring `<ScpStatementType as WriteXdr>::write_xdr`.
    pub const fn write_type_scp_statement_type(&mut self, v: &ScpStatementType) {
