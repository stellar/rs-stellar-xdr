...
impl SendMoreExtended {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_send_more_extended(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`SendMoreExtended`], mirroring `<SendMoreExtended as WriteXdr>::write_xdr`.
    pub const fn write_type_send_more_extended(&mut self, v: &SendMoreExtended) {
        self.write_u32(v.num_messages);
        self.write_u32(v.num_bytes);
    }
}
