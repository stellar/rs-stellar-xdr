...
impl SetOptionsResult {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_set_options_result(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`SetOptionsResult`], mirroring `<SetOptionsResult as WriteXdr>::write_xdr`.
    pub const fn write_type_set_options_result(&mut self, v: &SetOptionsResult) {
        let d = v.discriminant();
        self.write_type_set_options_result_code(&d);
        #[allow(clippy::match_same_arms)]
        match v {
            SetOptionsResult::Success => {}
            SetOptionsResult::LowReserve => {}
            SetOptionsResult::TooManySigners => {}
            SetOptionsResult::BadFlags => {}
            SetOptionsResult::InvalidInflation => {}
            SetOptionsResult::CantChange => {}
            ...
            SetOptionsResult::AuthRevocableRequired => {}
        }
    }
}
