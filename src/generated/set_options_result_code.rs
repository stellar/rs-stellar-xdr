...
#[cfg(feature = "alloc")]
impl IntoOwned for SetOptionsResultCode {
    type Owned = SetOptionsResultCode;
    fn into_owned(self) -> SetOptionsResultCode {
        self
    }
}
...
impl SetOptionsResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_set_options_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`SetOptionsResultCode`], mirroring `<SetOptionsResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_set_options_result_code(&mut self, v: &SetOptionsResultCode) {
