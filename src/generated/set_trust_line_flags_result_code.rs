...
impl SetTrustLineFlagsResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_set_trust_line_flags_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`SetTrustLineFlagsResultCode`], mirroring `<SetTrustLineFlagsResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_set_trust_line_flags_result_code(
        &mut self,
        v: &SetTrustLineFlagsResultCode,
    ) {
