...
impl SignerKeyType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_signer_key_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`SignerKeyType`], mirroring `<SignerKeyType as WriteXdr>::write_xdr`.
    pub const fn write_type_signer_key_type(&mut self, v: &SignerKeyType) {
