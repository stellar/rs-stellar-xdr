...
impl SimplePaymentResult {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_simple_payment_result(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`SimplePaymentResult`], mirroring `<SimplePaymentResult as WriteXdr>::write_xdr`.
    pub const fn write_type_simple_payment_result(&mut self, v: &SimplePaymentResult) {
