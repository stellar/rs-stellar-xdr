...
impl SorobanAuthorizedFunctionType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_soroban_authorized_function_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`SorobanAuthorizedFunctionType`], mirroring `<SorobanAuthorizedFunctionType as WriteXdr>::write_xdr`.
    pub const fn write_type_soroban_authorized_function_type(
        &mut self,
        v: &SorobanAuthorizedFunctionType,
    ) {
