...
impl SorobanCredentialsType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_soroban_credentials_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`SorobanCredentialsType`], mirroring `<SorobanCredentialsType as WriteXdr>::write_xdr`.
    pub const fn write_type_soroban_credentials_type(&mut self, v: &SorobanCredentialsType) {
