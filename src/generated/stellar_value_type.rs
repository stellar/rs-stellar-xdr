...
impl StellarValueType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_stellar_value_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`StellarValueType`], mirroring `<StellarValueType as WriteXdr>::write_xdr`.
    pub const fn write_type_stellar_value_type(&mut self, v: &StellarValueType) {
