...
impl SurveyResponseMessage {
    ...
    pub const fn const_write_xdr(&self, w: &mut ConstWriter) {
        w.enter_depth();
        self.surveyor_peer_id.const_write_xdr(w);
        self.surveyed_peer_id.const_write_xdr(w);
        w.write_u32(self.ledger_num);
        self.command_type.const_write_xdr(w);
        self.encrypted_body.const_write_xdr(w);
        w.leave_depth();
    }
