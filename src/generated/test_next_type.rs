...
impl TestNextType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_test_next_type(self);
        w.len()
    }
...
impl ConstWriter<'_> {
    #[cfg(feature = "test_feature")]
    /// Serializes a [`TestNextType`], mirroring `<TestNextType as WriteXdr>::write_xdr`.
    pub const fn write_type_test_next_type(&mut self, v: &TestNextType) {
        self.write_i32(v.value);
    }
}
