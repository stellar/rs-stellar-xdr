...
impl TimeSlicedSurveyStopCollectingMessage {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_time_sliced_survey_stop_collecting_message(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`TimeSlicedSurveyStopCollectingMessage`], mirroring `<TimeSlicedSurveyStopCollectingMessage as WriteXdr>::write_xdr`.
    pub const fn write_type_time_sliced_survey_stop_collecting_message(
        &mut self,
        v: &TimeSlicedSurveyStopCollectingMessage,
    ) {
