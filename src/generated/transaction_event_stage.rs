...
impl TransactionEventStage {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_transaction_event_stage(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`TransactionEventStage`], mirroring `<TransactionEventStage as WriteXdr>::write_xdr`.
    pub const fn write_type_transaction_event_stage(&mut self, v: &TransactionEventStage) {
