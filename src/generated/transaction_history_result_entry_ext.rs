...
impl TransactionHistoryResultEntryExt {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_transaction_history_result_entry_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`TransactionHistoryResultEntryExt`], mirroring `<TransactionHistoryResultEntryExt as WriteXdr>::write_xdr`.
    pub const fn write_type_transaction_history_result_entry_ext(
        &mut self,
        v: &TransactionHistoryResultEntryExt,
    ) {
        let d = v.discriminant();
        self.write_i32(d);
        #[allow(clippy::match_same_arms)]
        match v {
            TransactionHistoryResultEntryExt::V0 => {}
        }
    }
}
