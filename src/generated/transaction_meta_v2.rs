...
/// TransactionMetaV2View is a borrowing equivalent of [`TransactionMetaV2`], usable in
/// const contexts and convertible to the owned type via [`From`]/[`Into`].
#[derive(Clone, Debug, Hash, PartialEq, Eq, PartialOrd, Ord)]
pub struct TransactionMetaV2View<'a> {
...
#[cfg(feature = "alloc")]
impl From<&TransactionMetaV2View<'_>> for TransactionMetaV2 {
    #[must_use]
...
impl WriteXdr for TransactionMetaV2View<'_> {
    #[cfg(feature = "std")]
    fn write_xdr<W: Write>(&self, w: &mut Limited<W>) -> Result<(), Error> {
        w.with_limited_depth(|w| {
            self.tx_changes_before.write_xdr(w)?;
...
impl TransactionMetaV2View<'_> {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_transaction_meta_v2(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`TransactionMetaV2`], mirroring `<TransactionMetaV2 as WriteXdr>::write_xdr`.
    pub const fn write_type_transaction_meta_v2(&mut self, v: &TransactionMetaV2View<'_>) {
