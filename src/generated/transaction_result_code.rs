...
impl TransactionResultCode {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_transaction_result_code(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`TransactionResultCode`], mirroring `<TransactionResultCode as WriteXdr>::write_xdr`.
    pub const fn write_type_transaction_result_code(&mut self, v: &TransactionResultCode) {
