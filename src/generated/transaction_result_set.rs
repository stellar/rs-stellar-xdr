...
#[cfg(feature = "const")]
impl TransactionResultSetView<'_> {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_transaction_result_set(self);
        w.len()
    }
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_transaction_result_set(&mut self, v: &TransactionResultSetView<'_>) {
