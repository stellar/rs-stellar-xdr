...
/// TransactionV0View is a borrowing equivalent of [`TransactionV0`], usable in
/// const contexts and convertible to the owned type via [`From`]/[`Into`].
#[derive(Clone, Debug, Hash, PartialEq, Eq, PartialOrd, Ord)]
pub struct TransactionV0View<'a> {
    pub source_account_ed25519: Uint256,
    pub fee: u32,
    pub seq_num: SequenceNumber,
    pub time_bounds: Option<TimeBounds>,
...
#[cfg(feature = "alloc")]
impl From<&TransactionV0View<'_>> for TransactionV0 {
    #[must_use]
    fn from(v: &TransactionV0View<'_>) -> Self {
        Self {
...
impl WriteXdr for TransactionV0View<'_> {
    #[cfg(feature = "std")]
    fn write_xdr<W: Write>(&self, w: &mut Limited<W>) -> Result<(), Error> {
        w.with_limited_depth(|w| {
            self.source_account_ed25519.write_xdr(w)?;
...
impl TransactionV0View<'_> {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_transaction_v0(self);
        w.len()
    }
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_transaction_v0(&mut self, v: &TransactionV0View<'_>) {
        ...
        self.write_type_transaction_v0_ext(&v.ext);
    }
}
