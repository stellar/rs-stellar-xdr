...
#[cfg(feature = "const")]
impl TransactionV0EnvelopeView<'_> {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_transaction_v0_envelope(self);
        w.len()
    }
...
impl ConstWriter<'_> {
    ...
    pub const fn write_type_transaction_v0_envelope(&mut self, v: &TransactionV0EnvelopeView<'_>) {
