...
#[cfg(feature = "alloc")]
impl IntoOwned for TransactionV0Ext {
    type Owned = TransactionV0Ext;
    fn into_owned(self) -> TransactionV0Ext {
        self
    }
}
...
impl TransactionV0Ext {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_transaction_v0_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`TransactionV0Ext`], mirroring `<TransactionV0Ext as WriteXdr>::write_xdr`.
    pub const fn write_type_transaction_v0_ext(&mut self, v: &TransactionV0Ext) {
