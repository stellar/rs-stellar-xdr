...
impl TrustLineEntry {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_trust_line_entry(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`TrustLineEntry`], mirroring `<TrustLineEntry as WriteXdr>::write_xdr`.
    pub const fn write_type_trust_line_entry(&mut self, v: &TrustLineEntry) {
        ...
        self.write_type_trust_line_entry_ext(&v.ext);
    }
}
