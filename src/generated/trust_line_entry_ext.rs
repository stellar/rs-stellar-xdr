...
impl TrustLineEntryExt {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_trust_line_entry_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`TrustLineEntryExt`], mirroring `<TrustLineEntryExt as WriteXdr>::write_xdr`.
    pub const fn write_type_trust_line_entry_ext(&mut self, v: &TrustLineEntryExt) {
        ...
        match v {
            ...
            TrustLineEntryExt::V1(value) => {
                self.write_type_trust_line_entry_v1(value);
            }
        }
    }
}
