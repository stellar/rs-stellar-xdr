...
impl TrustLineEntryExtensionV2Ext {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_trust_line_entry_extension_v2_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`TrustLineEntryExtensionV2Ext`], mirroring `<TrustLineEntryExtensionV2Ext as WriteXdr>::write_xdr`.
    pub const fn write_type_trust_line_entry_extension_v2_ext(
        &mut self,
        v: &TrustLineEntryExtensionV2Ext,
    ) {
        let d = v.discriminant();
        self.write_i32(d);
        #[allow(clippy::match_same_arms)]
        match v {
            TrustLineEntryExtensionV2Ext::V0 => {}
        }
    }
}
