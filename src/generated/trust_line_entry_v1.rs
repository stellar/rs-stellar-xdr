...
#[cfg(feature = "alloc")]
impl IntoOwned for TrustLineEntryV1 {
    type Owned = TrustLineEntryV1;
    fn into_owned(self) -> TrustLineEntryV1 {
        self
    }
}
...
impl TrustLineEntryV1 {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_trust_line_entry_v1(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`TrustLineEntryV1`], mirroring `<TrustLineEntryV1 as WriteXdr>::write_xdr`.
    pub const fn write_type_trust_line_entry_v1(&mut self, v: &TrustLineEntryV1) {
        self.write_type_liabilities(&v.liabilities);
        self.write_type_trust_line_entry_v1_ext(&v.ext);
    }
}
