...
#[cfg(feature = "alloc")]
impl IntoOwned for TrustLineEntryV1Ext {
    type Owned = TrustLineEntryV1Ext;
    fn into_owned(self) -> TrustLineEntryV1Ext {
        self
    }
}
...
impl TrustLineEntryV1Ext {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_trust_line_entry_v1_ext(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`TrustLineEntryV1Ext`], mirroring `<TrustLineEntryV1Ext as WriteXdr>::write_xdr`.
    pub const fn write_type_trust_line_entry_v1_ext(&mut self, v: &TrustLineEntryV1Ext) {
        ...
        match v {
            ...
            TrustLineEntryV1Ext::V2(value) => {
                self.write_type_trust_line_entry_extension_v2(value);
            }
        }
    }
}
