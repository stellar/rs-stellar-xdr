...
impl TrustLineFlags {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_trust_line_flags(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`TrustLineFlags`], mirroring `<TrustLineFlags as WriteXdr>::write_xdr`.
    pub const fn write_type_trust_line_flags(&mut self, v: &TrustLineFlags) {
