...
impl TxSetComponentType {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_tx_set_component_type(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`TxSetComponentType`], mirroring `<TxSetComponentType as WriteXdr>::write_xdr`.
    pub const fn write_type_tx_set_component_type(&mut self, v: &TxSetComponentType) {
