...
impl UInt128Parts {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_u_int128_parts(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`UInt128Parts`], mirroring `<UInt128Parts as WriteXdr>::write_xdr`.
    pub const fn write_type_u_int128_parts(&mut self, v: &UInt128Parts) {
        self.write_u64(v.hi);
        self.write_u64(v.lo);
    }
}
