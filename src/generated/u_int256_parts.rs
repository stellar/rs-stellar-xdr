...
#[cfg(feature = "alloc")]
impl IntoOwned for UInt256Parts {
    type Owned = UInt256Parts;
    fn into_owned(self) -> UInt256Parts {
        self
    }
}
...
impl UInt256Parts {
    ...
    pub const fn const_xdr_len(&self) -> usize {
        ...
        w.write_type_u_int256_parts(self);
        w.len()
    }
...
#[cfg(feature = "const")]
impl ConstWriter<'_> {
    /// Serializes a [`UInt256Parts`], mirroring `<UInt256Parts as WriteXdr>::write_xdr`.
    pub const fn write_type_u_int256_parts(&mut self, v: &UInt256Parts) {
        self.write_u64(v.hi_hi);
