...
class Generator < Xdrgen::Generators::Base
  ...
  def render_top_matter(out)
    ...
    EOS
    out.break
    out.puts "#![allow(clippy::missing_errors_doc, clippy::unreadable_literal, clippy::semicolon_if_nothing_returned, clippy::absurd_extreme_comparisons, clippy::derivable_impls, clippy::unnecessary_semicolon, clippy::cast_possible_wrap, clippy::len_zero)]"
    out.break
